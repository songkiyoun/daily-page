# Circle Battle Tower Rebuild - Google Spreadsheet 저장 구조 v1.0.4
...
## v1.0.4 Apps Script 저장 연동 메모

v1.0.4 기준 `google-apps-script/Code.gs`는 `Accounts` 탭 헤더를 자동 보정합니다.
...
초기 테스트 과정에서 `id`, `pw` 헤더를 만들어둔 경우에도 v1.0.4 Apps Script가 `Accounts` 탭을 자동 보정합니다.
