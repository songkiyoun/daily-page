...
import { processBossActionLock, updateBossPattern } from './battle/bossPatterns.js';
import { CHARGE_GUARD_SKILLS, FORCED_CRIT_SKILLS, PASS_STRIKE_SKILLS, SEQUENCE_SKILLS, WEAPON_ATTACK_SKILL_TYPES, WEAPON_SKILL_CHAIN_LOCK_FRAMES } from './battle/skillConstants.js';
...
export function updateBattle(state) {
  ...
  updateBossPattern(state, { emitVisualEffect, emitCombatEvent, addScreenShake, getEffectiveDefense });
